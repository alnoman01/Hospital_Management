 ...
 <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="#" class="waves-effect waves-dark"><i class="fa fa-sitemap"></i> Patient <span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a href="paiteint_info.php">Patient Information</a>
                            </li>
                    ...
                    <li>
                        <a href="#" class="waves-effect waves-dark"><i class="fa fa-sitemap"></i> Doctor  <span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="#">Doctor Registration</a>
                            </li>
                            <li>
                                <a href="doctor_appointment.php">Create Appoinment</a>
                            </li>
                            <li>
                    ...
                    <li>
                        <a href="#" class="waves-effect waves-dark"><i class="fa fa-sitemap"></i> Others  <span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="diseases_symptoms.php">Diseases and Symtoms</a>
                            </li>
                            <li>
                                <a href="doctor_expert_section.php">Doctor Expert Section</a>
                            </li>
                            <li>
                                <a href="seat_management.php">Seat Management</a>
                            </li>
                            <li>
                                <a href="doctor_expertise.php">Doctor Experties</a>
                            </li>
