<?php
  if($_SERVER['REQUEST_METHOD'] == 'POST'){
      ...
      $sql = "INSERT INTO patient_registration(first_name,last_name,dob,phone_number,sex,email,paddress,p_password) VALUES ('$first_name','$last_name','$dob','$ph_number','$gender','$email','$address','$pass')";
